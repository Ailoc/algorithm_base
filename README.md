...
| 2    | [括号生成](#2️⃣-括号生成)                      | 递归   | [22. 括号生成 - 力扣（LeetCode）](https://leetcode.cn/problems/generate-parentheses/)      | 🟢 Easy |
...
| #    | 题目                                                         | 类型     | LeetCode                                                     | 难度   |
| ---- | ------------------------------------------------------------ | -------- | ------------------------------------------------------------ | ------ |
| 1    | [买卖股票的最佳时机 II](#1️⃣-买卖股票的最佳时机-II)                      | 贪心   | [122. 买卖股票的最佳时机 II - 力扣（LeetCode）](https://leetcode.cn/problems/best-time-to-buy-and-sell-stock-ii/description/)      | 🟢 Easy |
...
| #    | 题目                                                         | 类型     | LeetCode                                                     | 难度   |
| ---- | ------------------------------------------------------------ | -------- | ------------------------------------------------------------ | ------ |
| 1    | [十进制整数的反码](#1️⃣-十进制整数的反码)                      | 抑或运算   | [1009. 十进制整数的反码 - 力扣（LeetCode）](https://leetcode.cn/problems/complement-of-base-10-integer/description/)      | 🟢 Easy |
...
---
### 1️⃣ 买卖股票的最佳时机 II
<img width="500" height="800" alt="image" src="https://github.com/user-attachments/assets/617db61e-0a92-4649-8a04-53b66d6e916b" />
...
### 1️⃣ 十进制整数的反码
<img width="500" height="600" alt="image" src="https://github.com/user-attachments/assets/d0bf3aa2-9c35-4784-9a07-4adaf55f27a2" />
